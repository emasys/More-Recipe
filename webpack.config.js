...
module.exports = {
  ...
  plugins: DEBUG
    ? [// > Configure CSS Bundle file
      new ExtractTextPlugin({ filename: DIST_FILE_CSS_BUNDLE, disable: false, allChunks: true })]
    : [
      ...
      new webpack
        .optimize
        .UglifyJsPlugin({ sourceMap: false, mangle: false }),
      // > CSS Bundle
      new ExtractTextPlugin({ filename: DIST_FILE_CSS_BUNDLE, disable: false, allChunks: true }),
      // > Minimize CSS
