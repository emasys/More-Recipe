    ...
    return (
      <section className="">
        ...
        <div className="container">
          <div data-aos="zoom-out" className="row catalog-wrapper p-0 justify-content-center mt-80">
            <div className="col-lg-6 col-sm-12 text-center AuthInfo">
              <img
                ...
                alt="logo" width="200" height="200" className="mt-30"
              />

              <h1 className="text-white">Welcome !</h1>
              <p className=" lead mt-10 text-white bg-mirror p-10 ">
