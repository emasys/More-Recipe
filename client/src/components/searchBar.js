        ...
        <div className="collapse navbar-collapse justify-content-end" id="navbarSupportedContent">
          <ul className="navbar-nav">
            <li className="nav-item dropdown active">
              <a className="nav-link dropdown-toggl" href="#" id="navbarDropdownMenuLink" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                  Catalog
                </a>
              <div className="dropdown-menu" aria-labelledby="navbarDropdownMenuLink">
                <a className="dropdown-item" href="catalog.html#like">Most Liked</a>
                <a className="dropdown-item" href="catalog.html#fav">Most Favorited</a>
                <a className="dropdown-item" href="catalog.html#new">Latest</a>
              </div>
            </li>
